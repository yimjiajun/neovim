local function setup()
    ...
    local function setup_keymap()
        ...
        local keymap_setup = {
            ...
            },
            {
                ...
                support = (vim.fn.filereadable("tags") == 1 and vim.fn.exists(
                    ":Tagbar"
                ) == 0),
            },
            {
    ...
    vim.cmd(
        "command! -nargs=0 TelescopeSshList lua require('plugin.telescope').SshList()"
    )
end
    ...
    m.buffer_with_del = function(opts)
        ...
        opts.attach_mappings = function(prompt_bufnr, map)
            local delete_buf = function()
                ...
                vim.cmd(
                    [[lua require('plugin.telescope').Buffer().buffer_with_del()]]
                )
            end
            ...
            .new(opts, {
                ...
                attach_mappings = function(prompt_bufnr, map)
                    actions.select_default:replace(function()
                        ...
                        require("features.ssh").SshConnect(
                            name,
                            host,
                            port,
                            pass
