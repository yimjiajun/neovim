...
local function setup_gruvbox()
	...
	local overrides_colors = {
		...
		IncSearch = { bg = c.neutral_red, fg = c.dark0_hard, bold = true, italic = true },
		Search = { bg = c.bright_orange, fg = c.dark0_hard, bold = true },
		CurSearch = { bg = c.neutral_red, fg = c.dark0_hard, bold = true, italic = true },
		...
		TelescopePreviewTitle = {bg = "none", bold = true},
		TelescopePreviewNormal = {bg = "none" },
		TelescopePreviewBorder = {bg = "none"},
		TelescopeResultsTitle = {bg = "none", bold = true},
		TelescopeResultsNormal = {bg = "none" },
		TelescopeResultsBorder = {bg = "none" },
		TelescopePromptTitle = {bg = "none", bold = true},
		TelescopePromptNormal = {bg = "none",  bold = true},
