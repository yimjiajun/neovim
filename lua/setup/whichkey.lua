...
wk.register({
	f = {
		...
		c = {
			name = "Cscope",
			s = { "<cmd> cs find s <cword><CR><CR>", "(symbols) - all refrences"},
			g = { "<cmd> cs find g <cword><CR><CR>", "(globals) - global definition(s)"},
			c = { "<cmd> cs find c <cword><CR><CR>", "(calls) - all calls to the function name"},
			t = { "<cmd> cs find t <cword><CR><CR>", "(text) - all instances of the text"},
			d = { "<cmd> cs find d <cword><CR><CR>", "(called) - find functions that function"},
			e = { "<cmd> cs find e <cword><CR><CR>", "(egrep) - search for the word"},
			f = { "<cmd> cs find f <cfile><CR><CR>", "(files) - open the filename"},
			i = { "<cmd> cs find i <cfile><CR><CR>", "(includes) - find files that include the filename"},
		},
	},
