...
wk.register({
	f = { name = "Find", -- optional group name
		...
		s = {	name = "Specific",
			a = { "<cmd> lua require('telescope.builtin').live_grep({prompt_title='.S', default_text=vim.fn.expand('<cword>'), glob_pattern=[[**/*.S]]})<CR>", "assembly language"},
			A = { "<cmd> lua require('telescope.builtin').live_grep({prompt_title='.s', glob_pattern=[[**/*.S]]})<CR>", "assembly language"},
			...
			l = { "<cmd> lua require('telescope.builtin').live_grep({prompt_title='.ld', default_text=vim.fn.expand('<cword>'), glob_pattern=[[**/*.ld]]})<CR>", "linker"},
