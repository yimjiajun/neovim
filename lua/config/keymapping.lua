...
vim.api.nvim_set_keymap('n', '<C-Up>', '<cmd>m .-2<CR>==', { noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-Down>', '<cmd>m .+1<CR>==', { noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<C-Up>', "<cmd>'<,'>m '<-2<CR>gv=gv", { noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<C-Down>', "<cmd>'<,'>m'>+1<CR>gv=gv", { noremap = true, silent = true})
