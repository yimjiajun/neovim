...
local function setting_key_search()
	...
	keymap('n', '<Leader>fw',
		[[<cmd> lua require("config.function").SearchWord(vim.fn.expand("%:e"), "cursor") <CR>]], opts)
	...
	keymap('n', '<Leader>fK', [[<cmd> lua require("config.function").SearchWordByFile("Kconfig", "normal") <CR>]], opts)
	keymap('n', '<Leader>fk', [[<cmd> lua require("config.function").SearchWord("conf", "normal") <CR>]], opts)
	keymap('n', '<Leader>fm',
		[[<cmd> lua require("config.function").SearchWordByFile("CMakeLists.txt", "normal") <CR>]], opts)
	keymap('n', '<Leader>fM',
